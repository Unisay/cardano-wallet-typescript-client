 ...
 * no description
 */
export class ByronMigrationsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createByronWalletMigrationPlan(walletId: string, createShelleyWalletMigrationPlanRequest: CreateShelleyWalletMigrationPlanRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'walletId' is not null or undefined
        if (walletId === null || walletId === undefined) {
            throw new RequiredError("ByronMigrationsApi", "createByronWalletMigrationPlan", "walletId");
        }
        ...
        if (createShelleyWalletMigrationPlanRequest === null || createShelleyWalletMigrationPlanRequest === undefined) {
            throw new RequiredError("ByronMigrationsApi", "createByronWalletMigrationPlan", "createShelleyWalletMigrationPlanRequest");
        }


        // Path Params
        const localVarPath = '/byron-wallets/{walletId}/migrations/plan'
     ...
     */
    public async migrateByronWallet(walletId: string, migrateByronWalletRequest: MigrateByronWalletRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'walletId' is not null or undefined
        if (walletId === null || walletId === undefined) {
            throw new RequiredError("ByronMigrationsApi", "migrateByronWallet", "walletId");
        }


        // verify required parameter 'migrateByronWalletRequest' is not null or undefined
        if (migrateByronWalletRequest === null || migrateByronWalletRequest === undefined) {
            throw new RequiredError("ByronMigrationsApi", "migrateByronWallet", "migrateByronWalletRequest");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(migrateByronWalletRequest, "MigrateByronWalletRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
...
export class ByronMigrationsApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to createByronWalletMigrationPlan
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createByronWalletMigrationPlan(response: ResponseContext): Promise<CreateShelleyWalletMigrationPlan202Response > {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to migrateByronWallet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async migrateByronWallet(response: ResponseContext): Promise<Array<ListTransactions200ResponseInner> > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("403", response.httpStatusCode)) {
