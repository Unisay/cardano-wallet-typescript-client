...
* patate
*/
export class RandomFromXprv {
    'style'?: RandomFromXprvStyleEnum;
    'name': string;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return RandomFromXprv.attributeTypeMap;
    }
...
export type RandomFromXprvStyleEnum = "random" ;
