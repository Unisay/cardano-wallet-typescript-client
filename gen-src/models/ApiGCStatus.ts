...
export class ApiGCStatus {
    ...
    static getAttributeTypeMap() {
        return ApiGCStatus.attributeTypeMap;
    }
...
export type ApiGCStatusStatusEnum = "not_applicable" | "not_started" | "restarting" | "has_run" ;
