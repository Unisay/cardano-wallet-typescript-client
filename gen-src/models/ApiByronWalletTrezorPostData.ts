...
export class ApiByronWalletTrezorPostData {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "style",
            "baseName": "style",
            "type": "ApiByronWalletTrezorPostDataStyleEnum",
            "format": ""
        },
        {
            "name": "name",
    ...
    static getAttributeTypeMap() {
        return ApiByronWalletTrezorPostData.attributeTypeMap;
    }
...
export type ApiByronWalletTrezorPostDataStyleEnum = "trezor" ;
