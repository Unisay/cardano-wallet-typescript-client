...
export class NormalPayment {
    ...
    */
    'withdrawal'?: NormalPaymentWithdrawalEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "withdrawal",
            "baseName": "withdrawal",
            "type": "NormalPaymentWithdrawalEnum",
            "format": ""
        },
        {
            "name": "metadata",
    ...
    static getAttributeTypeMap() {
        return NormalPayment.attributeTypeMap;
    }
...
export type NormalPaymentWithdrawalEnum = "self" ;
