...
export class ApiSelectCoinsPayments {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "withdrawal",
            "baseName": "withdrawal",
            "type": "ApiSelectCoinsPaymentsWithdrawalEnum",
            "format": ""
        },
        {
            "name": "metadata",
    ...
    static getAttributeTypeMap() {
        return ApiSelectCoinsPayments.attributeTypeMap;
    }
...
export type ApiSelectCoinsPaymentsWithdrawalEnum = "self" ;
