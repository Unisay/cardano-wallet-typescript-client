...
export class CreateSharedWalletFromAccountPublicKey1 {
    'name': string;
    /**
    ...
    */
    'scriptValidation'?: CreateSharedWalletFromAccountPublicKey1ScriptValidationEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "CreateSharedWalletFromAccountPublicKey1ScriptValidationEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return CreateSharedWalletFromAccountPublicKey1.attributeTypeMap;
    }
...
export type CreateSharedWalletFromAccountPublicKey1ScriptValidationEnum = "required" | "recommended" ;
