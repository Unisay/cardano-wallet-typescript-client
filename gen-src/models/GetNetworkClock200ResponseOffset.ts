...
*/
export class GetNetworkClock200ResponseOffset {
    'quantity': number;
    'unit': GetNetworkClock200ResponseOffsetUnitEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "unit",
            "baseName": "unit",
            "type": "GetNetworkClock200ResponseOffsetUnitEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return GetNetworkClock200ResponseOffset.attributeTypeMap;
    }
...
export type GetNetworkClock200ResponseOffsetUnitEnum = "microsecond" ;
