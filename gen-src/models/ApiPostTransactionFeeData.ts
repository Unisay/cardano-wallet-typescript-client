...
export class ApiPostTransactionFeeData {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "withdrawal",
            "baseName": "withdrawal",
            "type": "ApiPostTransactionFeeDataWithdrawalEnum",
            "format": ""
        },
        {
            "name": "metadata",
    ...
    static getAttributeTypeMap() {
        return ApiPostTransactionFeeData.attributeTypeMap;
    }
...
export type ApiPostTransactionFeeDataWithdrawalEnum = "self" ;
