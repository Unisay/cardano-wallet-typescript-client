...
*/
export class ApiCertificate {
    'certificateType': ApiCertificateCertificateTypeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "ApiCertificateCertificateTypeEnum",
            "format": ""
        },
        {
            "name": "pool",
    ...
    static getAttributeTypeMap() {
        return ApiCertificate.attributeTypeMap;
    }
...
export type ApiCertificateCertificateTypeEnum = "mir" | "genesis" ;
