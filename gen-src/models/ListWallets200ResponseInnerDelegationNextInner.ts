...
*/
export class ListWallets200ResponseInnerDelegationNextInner {
    'status': ListWallets200ResponseInnerDelegationNextInnerStatusEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "status",
            "baseName": "status",
            "type": "ListWallets200ResponseInnerDelegationNextInnerStatusEnum",
            "format": ""
        },
        {
            "name": "target",
    ...
    static getAttributeTypeMap() {
        return ListWallets200ResponseInnerDelegationNextInner.attributeTypeMap;
    }
...
export type ListWallets200ResponseInnerDelegationNextInnerStatusEnum = "not_delegating" | "delegating" ;
