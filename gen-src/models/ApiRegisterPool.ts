...
export class ApiRegisterPool {
    'certificateType': ApiRegisterPoolCertificateTypeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "ApiRegisterPoolCertificateTypeEnum",
            "format": ""
        },
        {
            "name": "poolId",
    ...
    static getAttributeTypeMap() {
        return ApiRegisterPool.attributeTypeMap;
    }
...
export type ApiRegisterPoolCertificateTypeEnum = "register_pool" ;
