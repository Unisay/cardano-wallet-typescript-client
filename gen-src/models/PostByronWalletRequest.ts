...
export class PostByronWalletRequest {
    'style'?: PostByronWalletRequestStyleEnum;
    'name': string;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "style",
            "baseName": "style",
            "type": "PostByronWalletRequestStyleEnum",
            "format": ""
        },
        {
            "name": "name",
    ...
    static getAttributeTypeMap() {
        return PostByronWalletRequest.attributeTypeMap;
    }
...
export type PostByronWalletRequestStyleEnum = "random" ;
