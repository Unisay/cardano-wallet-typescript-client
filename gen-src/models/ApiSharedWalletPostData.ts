...
import { CreateSharedWalletFromAccountPublicKey1 } from './CreateSharedWalletFromAccountPublicKey1';
import { CreateSharedWalletFromMnemonics1 } from './CreateSharedWalletFromMnemonics1';
...
export class ApiSharedWalletPostData {
    'name': string;
    /**
    ...
    */
    'scriptValidation'?: ApiSharedWalletPostDataScriptValidationEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "ApiSharedWalletPostDataScriptValidationEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return ApiSharedWalletPostData.attributeTypeMap;
    }
...
export type ApiSharedWalletPostDataScriptValidationEnum = "required" | "recommended" ;
