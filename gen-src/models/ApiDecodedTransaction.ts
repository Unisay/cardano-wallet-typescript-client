...
export class ApiDecodedTransaction {
    /**
    ...
    */
    'scriptValidity'?: ApiDecodedTransactionScriptValidityEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "ApiDecodedTransactionScriptValidityEnum",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return ApiDecodedTransaction.attributeTypeMap;
    }
...
export type ApiDecodedTransactionScriptValidityEnum = "valid" | "invalid" ;
