...
export class ApiPostAccountKeyDataWithPurpose {
    /**
    ...
    */
    'format': ApiPostAccountKeyDataWithPurposeFormatEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "format",
            "baseName": "format",
            "type": "ApiPostAccountKeyDataWithPurposeFormatEnum",
            "format": ""
        },
        {
            "name": "purpose",
    ...
    static getAttributeTypeMap() {
        return ApiPostAccountKeyDataWithPurpose.attributeTypeMap;
    }
...
export type ApiPostAccountKeyDataWithPurposeFormatEnum = "extended" | "non_extended" ;
