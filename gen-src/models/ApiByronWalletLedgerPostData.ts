...
export class ApiByronWalletLedgerPostData {
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "style",
            "baseName": "style",
            "type": "ApiByronWalletLedgerPostDataStyleEnum",
            "format": ""
        },
        {
            "name": "name",
    ...
    static getAttributeTypeMap() {
        return ApiByronWalletLedgerPostData.attributeTypeMap;
    }
...
export type ApiByronWalletLedgerPostDataStyleEnum = "ledger" ;
