...
export class ListAssets200ResponseInner {
    /**
    ...
    */
    'metadataError'?: ListAssets200ResponseInnerMetadataErrorEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "ListAssets200ResponseInnerMetadataErrorEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ListAssets200ResponseInner.attributeTypeMap;
    }
...
export type ListAssets200ResponseInnerMetadataErrorEnum = "fetch" | "parse" ;
